...
public class LivroApp {
    ...
    // Métodos auxiliares
    private static void adicionarLivro(Scanner scanner, List<Livro> livros) {
    ...
    private static void alterarLivro(Scanner scanner, List<Livro> livros) {
    ...
    private static void removerLivro(Scanner scanner, List<Livro> livros) {
